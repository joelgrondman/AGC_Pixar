...
void Mesh::dispVertInfo(Vertex *dVert) {
    qDebug() << "Vertex at Index =" << dVert->index << "Coords =" << dVert->coords << "Out =" << dVert->out->index << "Val =" << dVert->val;
}

void Mesh::dispHalfEdgeInfo(HalfEdge *dHalfEdge) {
    qDebug() << "HalfEdge at Index =" << dHalfEdge->index << "Target =" << dHalfEdge->target->index << "Next =" << dHalfEdge->next->index << "Prev =" << dHalfEdge->prev->index << "Twin =" << dHalfEdge->twin->index << "Poly =" << dHalfEdge->polygon;
}
